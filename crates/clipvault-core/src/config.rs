...
impl ClipvaultPaths {
    pub fn discover() -> Result<Self> {
        let project = ProjectDirs::from("", "", "clipvault")
            .context("could not resolve XDG directories for clipvault")?;
        ...
        Ok(Self {
            db_path: state_dir.join("clipvault.db"),
            log_path: state_dir.join("clipvault.log"),
            socket_path: runtime_dir.join("clipvault.sock"),
            config_dir,
            state_dir,
            data_dir,
            image_dir,
